...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot,MyIFileTable<String,BufferedReader> fileTable ,IStmt prg,MyIHeap heap,ILockTable locktable){
        exeStack=stk;
        symTable=symtbl;
        out = ot;
        this.heap = heap;
