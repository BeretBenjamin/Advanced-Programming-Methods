...
public class programsList {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState prg1 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(), new MyList<Value>(),
                                        new MyFileTable<String, BufferedReader>(), selectedStatement, new MyHeap(), new LatchTable());
    ...
    private ObservableList<IStmt> getAllStatements() {
        ...
        IStmt ex9 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())), new CompStmt(new VarDeclStmt("v2", new RefType(new IntType())), new CompStmt(new VarDeclStmt("v3", new RefType(new IntType())), new CompStmt(new VarDeclStmt("cnt", new IntType()), new CompStmt(new NewStatement("v1", new ValueExp(new IntValue(2))), new CompStmt(new NewStatement("v2", new ValueExp(new IntValue(3))), new CompStmt(new NewStatement("v3", new ValueExp(new IntValue(4))), new CompStmt(new NewLatch("cnt", new ReadHeap(new VarExp("v2"))), new CompStmt(new ForkStatement(new CompStmt(new WriteHeapStatement("v1", new ArithExp("*", new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(10)))), new CompStmt(new PrintStmt(new ReadHeap(new VarExp("v1"))), new CompStmt(new CountDown("cnt"), new ForkStatement(new CompStmt(new WriteHeapStatement("v2", new ArithExp("*", new ReadHeap(new VarExp("v2")), new ValueExp(new IntValue(10)))), new CompStmt(new PrintStmt(new ReadHeap(new VarExp("v2"))), new CompStmt(new CountDown("cnt"), new ForkStatement(new CompStmt(new WriteHeapStatement("v3", new ArithExp("*", new ReadHeap(new VarExp("v3")), new ValueExp(new IntValue(10)))), new CompStmt(new PrintStmt(new ReadHeap(new VarExp("v3"))), new CountDown("cnt")))))))))))), new CompStmt(new Await("cnt"), new CompStmt(new PrintStmt(new ValueExp(new IntValue(100))), new CompStmt(new CountDown("cnt"), new PrintStmt(new ValueExp(new IntValue(100)))))))))))))));
