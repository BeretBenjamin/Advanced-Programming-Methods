...
import model.stmt.*;
import model.type.*;
import model.utils.SemaphoreTable;
...
public class programsList {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState prg1 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(), new MyList<Value>(),
                                        new MyFileTable<String, BufferedReader>(), selectedStatement, new MyHeap(), new SemaphoreTable());
    ...
    private ObservableList<IStmt> getAllStatements() {
        ...
        //print(rh(v1)-1);
        //release(cnt)
        //The final Out should be {20,200,199} or {20,19,400}.
        ...
        IStmt ex9 = new CompStmt(
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                new NewStatement("v1", new ValueExp(new IntValue(2))),
                                new CompStmt(
                                        new NewSemaphore("cnt", new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(1))),
                                        new CompStmt(
                                                new ForkStatement(
                                                        new CompStmt(
                                                                new AcquireStatement("cnt"),
                                                                new CompStmt(
                                                                        new WriteHeapStatement("v1", new ArithExp("*", new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                                                                        new CompStmt(
                                                ...
                                                new CompStmt(
                                                        new ForkStatement(
                                                                new CompStmt(
                                                                        ...
                                                                        new CompStmt(
                                                                                new WriteHeapStatement("v1", new ArithExp("*",  new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                                                                                new CompStmt(
                                                                                        new WriteHeapStatement("v1", new ArithExp("*",  new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(2)))),
                                                                                        new CompStmt(
                                                                                                new PrintStmt(new ReadHeap(new VarExp("v1"))),
                                                                                                new ReleaseStatement("cnt")
                                                                                        )
                                                        ...
                                                        new CompStmt(
                                                                new AcquireStatement("cnt"),
                                                                new CompStmt(
                                                                        new PrintStmt(new ArithExp("-", new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(1)))),
                                                                        new ReleaseStatement("cnt")
                                                                )
                                                        )
                                                )
