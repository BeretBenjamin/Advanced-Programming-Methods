...
public class programController {
    ...
    @FXML
    private TableView<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>> semaphoreTableView;

    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, Integer> indexSemaphoreTableColumn;

    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, Integer> valueSemaphoreTableColumn;

    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, List<Integer>> listSemaphoreTableColumn;
    ...
    public void initialize() {
        ...
        valueSemaphoreTableColumn.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getValue().getFirst() - p.getValue().getValue().getThird()).asObject());
        listSemaphoreTableColumn.setCellValueFactory(p -> new SimpleObjectProperty<>(p.getValue().getValue().getSecond()));
    }
    ...
    private void populateHeapTableView() {
        ...
        for (HashMap.Entry<Integer, Value> entry: heap.getContent().entrySet()) {
    ...
    private void populateToySemaphoreTableView() {
        ...
        semaphoreTableView.setItems(FXCollections.observableArrayList(toySemaphoreList));
