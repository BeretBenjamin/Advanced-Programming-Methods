...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot,MyIFileTable<String,BufferedReader> fileTable ,IStmt prg,MyIHeap heap, ISemaphoreTable semaphoretbl){
        exeStack=stk;
        symTable=symtbl;
        out = ot;
        this.heap = heap;
        ...
        id = setFreeAddress();
        this.semaphoreTable=semaphoretbl;
        stk.push(prg);
    }
    ...
    public void setSemaphoreTable(ISemaphoreTable semaphoreTaable) {this.semaphoreTable=semaphoreTaable;}
