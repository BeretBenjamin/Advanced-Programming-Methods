    ...
    private ObservableList<IStmt> getAllStatements() {
        ...
        IStmt ex10 = new CompStmt(new VarDeclStmt("a", new RefType(new IntType())),
                new CompStmt(new VarDeclStmt("b", new RefType(new IntType())),
                        new CompStmt(new VarDeclStmt("v", new IntType()),
                                new CompStmt(new NewStatement("a", new ValueExp(new IntValue(0))),
                                        new CompStmt(new NewStatement("b", new ValueExp(new IntValue(0))),
                                                new CompStmt(new WriteHeapStatement("a", new ValueExp(new IntValue(1))),
                                                        new CompStmt(new WriteHeapStatement("b", new ValueExp(new IntValue(2))),
                                                                new CompStmt(new ConditionalAssignment("v", new RelationalExpressions("<", new ReadHeap(new VarExp("a")), new ReadHeap(new VarExp("b"))), new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200))),
                                                                        new CompStmt(new PrintStmt(new VarExp("v")),
                                                                                new CompStmt(new ConditionalAssignment("v", new RelationalExpressions(">", new ArithExp("-", new ReadHeap(new VarExp("b")), new ValueExp(new IntValue(2))), new ReadHeap(new VarExp("a"))), new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200))),
                                                                                        new PrintStmt(new VarExp("v"))
                                                                                )
                                                                        )
                                                                )
